---
id: version-3.3.0_Viet-installation
title: Cài đặt
...
thông tin `<version>`, v.d, `3.3.0`. Xem danh sách các phiên bản SINGA đang hoạt
động ở đường dẫn.
...
Bạn có thể thiết lập phiên bản SINGA và CUDA, như `singa==3.3.0+cuda10.2`. Danh
